!(function (e, n) {
    ...
    function t(e, n, t) {
        return (
            !t.removeZeroUnits || 0 !== e.value || n.some((e) => 0 !== e.value)
        );
    }
    function o(e, n, o) {
        const s = e
                ...
                n.parentNode && c.observe(n.parentNode, { childList: !0 }),
                {
                    ...
                    updateCountdown: (e) => {
                        ...
                        Object.assign(t, e),
                            ...
                            a.isPaused ||
                                (a.interval && clearInterval(a.interval), u());
                    },
                    getState: () => ({ ...a }),
                }
            );
